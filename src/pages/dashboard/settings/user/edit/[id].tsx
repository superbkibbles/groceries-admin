...
import { fetchUserSettings, updateUserSetting, setCurrentSetting } from '@/store/slices/settingsSlice';
...
export default function EditUserSetting() {
  ...
  const { userSettings, loading, error } = useAppSelector((state) => state.settings);
